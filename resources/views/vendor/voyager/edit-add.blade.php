            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            @include('voyager::multilingual.input-hidden', [
                                '_field_name'  => 'sub_title',
                                '_field_trans' => get_field_translations($dataTypeContent, 'sub_title')
                            ])
                            <input type="text" class="form-control" id="sub_title" name="sub_title" placeholder="{{ __('voyager::generic.sub_title') }}" value="{{ $dataTypeContent->sub_title ?? '' }}">
                        </div>
                    </div>
